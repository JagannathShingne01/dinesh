...
const About = () => {
  return (
    <div className=" min-h-[85vh] flex flex-col lg:flex-row justify-between items-center lg:px-44 px-5 pt-24 lg:pt-1 gap-5 ">
      <div className=" w-full lg:w-3/4 space-y-4 ">
       
        <h1 className=" text-5xl text-brightColor font-semibold text-center lg:text-start flex">  <MdKeyboardDoubleArrowRight className="text-5xl text-brightColor"/>About Us</h1>
        <p className=" text-justify lg:text-start pr-8">
